...
myinst=createGiottoInstructions(save_plot=T, show_plot=F, save_dir=dir.output, python_path="/Users/emmanueldollinger/opt/anaconda3/envs/stlearn/bin/python3")
