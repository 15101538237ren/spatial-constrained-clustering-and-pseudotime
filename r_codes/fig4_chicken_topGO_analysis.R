...
output_dir = "../output"
dataset_name = "chicken_bk"
sample_name = "Valve cells_MT-enriched valve cells"
method_name = "DGI_SP"
...
marker_genes_filename = "unique_cluster_specific_marker_genes_top_10.tsv"
...
db= useMart('ENSEMBL_MART_ENSEMBL',dataset='ggallus_gene_ensembl')
...
ggsave(paste(c(input_dir_fp, target_fig_name), collapse = '/'), width=5.5, height=4, dpi=300)
